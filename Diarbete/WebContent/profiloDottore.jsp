		...
		<div class="card col-xs-12" style="margin-top: 30px">
			...
			<div style="height: 230px">
				<div style=" float: left;">
					<img class="img-responsive" src="img/homedottore/pazienti.jpg"
			...
			<div class="panel panel-info"
				...
				<div class="panel-body">
					<iframe width="100%" height="230px" frameborder="0" style="border: 0"
						src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDoSwVvCAM_pT2dLFIRtLolHOy59ouWjCk&q=Sandro+pertini+ospedale"
			...
			<div class="panel panel-info"
				style="float: left; height: 100px; width: 100%;">
				<div class="panel-heading">Breve Descrizione Curriculum</div>

				<div class="panel-body">Il dottore ha
					studiatoo---......................</div>
			</div>
