...
<body>
	...
	<section class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="panel panel-primary">
				<div id="nomeFarmacia" class="panel-heading text-center">Farmacie nei dintorni
					di</div>
				<div class="panel-body">
					<iframe id="iframe" width="100%" height="500px" frameborder="0"
	...
	<script>
		...
		document.getElementById("nomeFarmacia").innerHTML="Farmacie nei dintorni di "+luogo;
