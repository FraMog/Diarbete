...
<%}}else{%>
    ...
    <div class="alert alert-danger fade in">
        ...
        <strong>Errore!</strong> Il server non ha potuto trovare i dati relativi al topic. Questo può essere dovuto ad un errore interno oppure ad un url scorretto. Si prega di riprovare più tardi.
    </div>
