...
<body>
    ...
    <section class="row">
        <div class="container">
            ...
            <p class="lead">
                Nel <b>forum</b> potrai aprire nuovi topics per permettere ad altri di chiarire i tuoi dubbi.
            </p>
                        ...
                        <div class="col-xs-12 col-sm-3" style="padding-top: 20px;">
                            <div id="custom-search-input">
                                <div class="input-group col-xs-12" style="height: 10px;">
                                    <input type="text" name="titoloPostdaCercare" id="titoloPostDaCercare" class="form-control input-xs-12" placeholder="Inserisci titolo topic" /> <span class="input-group-btn">
